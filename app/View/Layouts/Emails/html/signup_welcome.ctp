	...
	<div style="width:516px;background:white;margin:15px auto;overflow:auto;font-family:'helvetica'">
		...
		<div style="width:440px;margin:0 auto">
			<?php 
				...
				$user_pass = $user['User']['tmp_passwd'];
				$admin_URL = Router::url(array('ajax'=>false,'controller'=>'users','action'=>'admin',$user['User']['slug']),true);
				$password_change_URL = Router::url(array('ajax'=>false,'controller'=>'users','action'=>'admin',$user['User']['slug']),true);
			?>
			...
			<div style="width:440px;margin:0 auto">
				...
				<ul>
					...
					<li>temporary password: <?php echo $user_pass; ?><br/>You can change this by visiting <?php echo $this->Html->link($password_change_URL,$password_change_URL); ?></li>
					<li>URL: <?php echo $this->Html->link($admin_URL,$admin_URL,array('style'=>'color:#ef3f23')); ?></li>
				</ul>
			</div>
		</div>
